...
*
* Copyright (C) 2024 Ivan Moskalenko, Anastasiia Kornilova, Skoltech
...
int main(int argc, char **argv)
{
    if(argc != 5)
    {
        cerr << endl << "Usage: ./rgbd_inertial_kinect path_to_vocabulary path_to_settings path_to_sequence path_to_association" << endl;
        return 1;
    }
    ...
    {
        cerr << "ERROR: Failed to load IMU for sequence" << endl;
        return 1;
    }
